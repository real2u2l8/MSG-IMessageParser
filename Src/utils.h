 ...
 * 
 * @details
 * 파일 경로 처리, 출력 디렉토리 관리, 날짜/시간 처리 등
 * 범용적으로 사용되는 유틸리티 함수들을 정리합니다.
 */
namespace Utils {
     ...
     * 
     * @note
     * 검사 실패 시 상세한 오류 메시지를 표준 오류 출력에 출력합니다.
     */
     ...
     * ERROR_ALREADY_EXISTS 오류는 성공으로 처리합니다.
     */
